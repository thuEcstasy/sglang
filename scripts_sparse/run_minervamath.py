...
def main():
    ...
    output_path = f"../output/{model_name}/minervamath_output_prompt_len_{args.prompt_len}_num_pages_{num_pages if not args.use_dense_kv else 'dense'}_{args.algo}.jsonl"
