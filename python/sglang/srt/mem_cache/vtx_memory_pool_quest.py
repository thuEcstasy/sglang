...
from vortex import set_kv_buffer_launcher, update_landmark_launcher_quest
...
class VTXTokenToKVPoolQuest(KVCache):
    ...
    def _create_buffers(self):
        with self.memory_saver_adapter.region(GPU_MEMORY_TYPE_KV_CACHE):
            with (
                ...
                # store 2 landmarks for each page: block-wise max and block-wise min
